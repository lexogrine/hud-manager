			...
			{cxt => (
				<Nav tabs className={`navbar-container ${isCollapsed ? 'collapsed' : ''}`}>
					...
					<div className="navbar-links-container">
						<NavItem
							className={`hover-pointer ${getClassForTab('HUDs', cxt)}`}
						...
						<GameOnly game={['csgo', 'dota2', 'rocketleague']}>
							<NavItem
								className={`hover-pointer ${getClassForTab('Teams', cxt)}`}
								onClick={toggleHandler('teams')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('Players', cxt)}`}
								onClick={toggleHandler('players')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('Matches', cxt)}`}
								onClick={toggleHandler('matches')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('Tournaments', cxt)}`}
								onClick={toggleHandler('tournaments')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('CG Mode', cxt)}`}
						...
						<GameOnly game="csgo">
							<NavItem
								className={`hover-pointer ${getClassForTab('ACO', cxt)}`}
								onClick={toggleHandler('aco')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('ARG', cxt)}`}
								onClick={toggleHandler('arg')}
							>
							...
							<NavItem
								className={`hover-pointer ${getClassForTab('AR', cxt)}`}
								onClick={toggleHandler('ar')}
							>
							...
							{ cxt.customer?.user?.id === 1 ? <NavItem className={`hover-pointer`} onClick={toggleHandler('xray')}>
						...
						<GameOnly game={['csgo', 'dota2', 'rocketleague']}>
							<NavItem
								className={`hover-pointer ${getClassForTab('Cameras', cxt)}`}
								onClick={toggleHandler('cameras')}
							>
