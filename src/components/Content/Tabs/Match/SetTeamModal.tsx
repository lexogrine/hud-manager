    ...
    return (
      <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} className={'veto_modal'}>
        ...
        <ModalFooter className="no-padding">
          <Button color="primary" onClick={this.save} className="modal-save">Save</Button>
        </ModalFooter>
      </Modal>
    );
  }
...
class TeamModal extends React.Component<{ button: JSX.Element, side: 'right' | 'left', team: any, teams: I.Team[], onSave: Function }, { isOpen: boolean }> {
  state = {
    isOpen: false
  }
  toggle = () => {
  ...
  render() {
    return <React.Fragment>
      ...
      <SetTeamModal isOpen={this.state.isOpen} toggle={this.toggle} side={this.props.side} team={this.props.team} teams={this.props.teams} onSave={this.props.onSave} />
    </React.Fragment>
  }
}
