        ...
        return (
            <div className={`bracket depth-${depth}`}>
                ...
                <div className="bracket-details">
                    <div
                        className={`match-connector ${!matchup.parents.length || parentsToRender.length === 0 ? 'first-match' : ''
                            } ${isLast ? 'last-match' : ''}`}
                    ></div>
                    ...
                    <div className="match-details" onClick={this.openModal(matchup._id, matchup.matchId || '')}>
                        <div className="team-data">
                            ...
                            <div className={`team-score ${match.left.score === winsRequired ? 'win':''}`}>{match.left.score}</div>
                        </div>
                        <div className="team-data">
                            <div className="team-logo">
                                {match.right.logo ? (
                            ...
                            <div className={`team-score ${match.right.score === winsRequired ? 'win':''}`}>{match.right.score}</div>
                        </div>
                    </div>
                </div>
