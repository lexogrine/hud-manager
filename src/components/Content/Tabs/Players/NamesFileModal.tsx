        ...
        <Modal isOpen={isOpen} toggle={toggleAndClear} className="veto_modal">
            ...
            <ModalBody>
                <Row>
                    <Col md="12">
                        <FormGroup>
                            <Input type="select" multiple id="player_for_names" name="player_for_names" onChange={onChange} value={checkedPlayersId}>
            ...
            <ModalFooter className="no-padding">
                <Button comp color="primary" className="modal-save" onClick={download} disabled={!checkedPlayersId.length}>
                    {t('common.save')}
                </Button>
            </ModalFooter>
        </Modal>
