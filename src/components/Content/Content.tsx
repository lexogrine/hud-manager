    ...
    render() {
        return (
            <div className="main-container">
                <Navbar activeTab={this.state.activeTab} toggle={this.toggle} files={this.state.gsi && this.state.configs}/>
                <Col>
                    <Tabs activeTab={this.state.activeTab} data={this.state.data} toggle={this.toggle} gsiCheck={this.checkFiles}/>
                </Col>
            </div>
        );
    }
