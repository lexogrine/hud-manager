        ...
        <Modal isOpen={isOpen} toggle={() => { }} className="veto_modal">
            ...
            <ModalBody>
                <div className="games-picker">
                    <div className={`game-preview ${game === 'csgo' ? 'active' : ''}`} onClick={() => setCurrentGame('csgo')}>
                        <div className="game-title">CSGO</div>
                        <div className="game-img"><img src={csgo} /></div>
                    </div>
                    <div className={`game-preview ${game === 'rocketleague' ? 'active' : ''}`} onClick={() => setCurrentGame('rocketleague')}>
                        <div className="game-title">Rocket League</div>
                        <div className="game-img"><img src={rl} /></div>
                    </div>
                </div>
            </ModalBody>
