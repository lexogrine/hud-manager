...
exports.updateTeamFields = exports.getTeamFields = exports.initiateCustomFields = exports.getTeamsList = exports.getTeamById = void 0;
var database_1 = __importDefault(require("./../../../init/database"));
var teams = database_1["default"].teams, custom = database_1["default"].custom;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!store)
                    return [2 /*return*/, []];
                return [2 /*return*/, store.teams];
        }
    });
}); };
exports.updateTeamFields = function (teamFields) { return __awaiter(void 0, void 0, void 0, function () {
