...
>Note #2 - to use AFX (experimental) mode, beside specifing the path to the newest version of HLAE you are also required to set the path to the afx-cefhud-interop.exe file, which you can find in the Release-Base.7z archive here: https://drive.google.com/drive/folders/1CQFGMYhmz4x9DxunmwhWMp37ow6YOBON
